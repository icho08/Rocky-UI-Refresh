...
public final class ColorUtils {
	...
	public static Color getClientColor() {
		int r = (int) dev.i726.rocky.gui.Theme.red;
		int g = (int) dev.i726.rocky.gui.Theme.green;
		int b = (int) dev.i726.rocky.gui.Theme.blue;
		
		if (dev.i726.rocky.gui.Theme.rainbow) {
			return getBreathingRGBColor(0, 255);
		} else if (dev.i726.rocky.gui.Theme.breathing) {
			return getMainColor(new Color(r, g, b), 0, 1);
		}
